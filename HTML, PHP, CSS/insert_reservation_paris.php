...
//On insere dans la table buffet, ici le lieu est paris car nous somme sur la page de reservation pour paris
$query3 = "INSERT INTO buffet VALUES ('$numtable','paris',$idreservation)";
